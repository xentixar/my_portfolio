                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="card bg-dark">
                        <div class="card-body text-light">
                            <h5 class="card-title"><a class="text-decoration-none text-light"
                                    href="{{ $repo['html_url'] }}">{{ $repo['name'] }} </a></h5>
                            <p class="card-text text-secondary">{{ $repo['full_name'] }}</p>
                            <hr>
                            <p class="card-text text-secondary">{{ $repo['language'] ?? 'null' }}</p>
                            <hr>
                            <p class="card-text" style="height: 20px;overflow:hidden">
                                {{ substr($repo['description'] ? $repo['description'] : 'null', 0, 40) }}...</p>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-4 text-center">
                                    <i class="fa-solid fa-fork text-warning"></i>
